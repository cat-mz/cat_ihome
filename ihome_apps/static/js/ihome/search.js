            ...
            if (areaId) {
                ...
                for (var i=0; i<data.data.length; i++) {
                    ...
                    if (data.data[i].aid == areaId) {
                        $(".filter-area").append('<li area-id="'+ data.data[i].aid+'" class="active">'+ data.data[i].area_name+'</li>');
                    } else {
                        $(".filter-area").append('<li area-id="'+ data.data[i].aid+'">'+ data.data[i].area_name+'</li>');
                    }
                }
            } else {
