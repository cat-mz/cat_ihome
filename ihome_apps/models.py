...
from . import db
from ihome_apps.constants import QINIU_URL,HOUSE_DETAIL_COMMENT_DISPLAY_COUNTS
...
class User(BaseModel, db.Model):
    ...
    def password(self):
        ...
        # return "xxx"
        # 设置只能存,不能拿
        raise AttributeError("设置只能存,不能拿")

    @password.setter
    def password(self,regex):
        '''
        设置密码
        users.password=regex
        regex=对应原始密码
        '''
        self.password_hash=generate_password_hash(regex)
...
'''
    ...
    def to_dict(self):
        ...
        user_dict = {
            ...
            "name": self.name,
            "mobile": self.mobile,
            "avatar": QINIU_URL + self.avatar_url if self.avatar_url else "",
...
class House(BaseModel, db.Model):
    ...
    def to_basic_dict(self):
        ...
        house_dict = {
            ...
            "img_url": QINIU_URL + "/" +  self.index_image_url if self.index_image_url else "",
            "room_count": self.room_count,
            "order_count": self.order_count,
            "address": self.address,
            "user_avatar": QINIU_URL + "/" +  self.user.avatar_url if self.user.avatar_url else "",
    ...
    def to_full_dict(self):
        ...
        for image in self.images:
            img_urls.append(QINIU_URL + "/" +  image.url)
...
class Order(BaseModel, db.Model):
    ...
    trade_no=db.Column(db.String(80)) #交易的支付宝流水号
    ...
    def to_dict(self):
        ...
        order_dict = {
            ...
            "img_url": QINIU_URL + "/" + self.house.index_image_url if self.house.index_image_url else "",
